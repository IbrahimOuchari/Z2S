...
class ResUser(models.Model):
    ...
    sales = fields.Float(string="Objectif")
...
class CRMLead(models.Model):
    ...
    crm_manager_id = fields.Many2one("res.users", string="CRM Manager",
                                     store=True)
    monthly_goal = fields.Float(string="Objectif Mensuel")
    achievement_amount = fields.Float(string="Réalisation Mensuelle")
    ...
    def get_the_annual_target(self):
        ...
        name = ["Objectif Annuel", "Cummul sur l'Année", "Gagné"]
        final = [value, name]
    ...
    def revenue_count_pie(self):
        ...
        revenue_pie_title = ['Attendu', 'Gagné', 'perdu']
