...
class AccountPaymentRegister(models.TransientModel):
    ...
    wht_tax_line_ids = fields.One2many("withholding.tax.line", 'payment_reg_id',
                                       string="Enregistrement Paiement Retenue à la Source")
    ...
    def _create_payment_vals_from_wizard(self):
        payment_vals = {
            ...
            'num_ch': self.num_ch,
            'date_ch': self.date_ch,
            'num_traite': self.num_traite,
            'date_traite': self.date_traite,
            'date_vir': self.date_vir
        }
...
class WithholdingTaxLine(models.TransientModel):
    ...
    payment_reg_id = fields.Many2one('account.payment.register', string="Compte Comptable")
    tax_id = fields.Many2one('account.tax', string="Taux RAS")
    name = fields.Char(string="Description")
    amount_withholding = fields.Float(string="Montant Retenue à la Source", digits='Product Price')
