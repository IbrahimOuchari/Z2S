...
class PaymentWthLine(models.Model):
    ...
    amount_wht = fields.Float(string="Montant", digits='Product Price')


class AccountPayment(models.Model):
    _inherit = "account.payment"

    wht_line_ids = fields.One2many("payment.wht.line", 'payment_id', string="Lignes d'Enregistrement des Paiements")
    is_wht_trx = fields.Boolean(string="Ecriture Multiple")
    is_pass_writeoff = fields.Boolean(string="Ecriture Multiple de journaux", help="transmettre les éléments de journal d'écriture sur plusieurs comptes")
