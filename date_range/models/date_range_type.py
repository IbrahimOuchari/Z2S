...
class DateRangeType(models.Model):
    ...
    company_id = fields.Many2one(
        comodel_name="res.company", string="Société", index=1, default=_default_company
    )
    date_range_ids = fields.One2many("date.range", "type_id", string="Plages")
    ...
    autogeneration_date_start = fields.Date(
        string="Date de début de la génération automatique",
