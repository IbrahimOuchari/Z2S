...
class AccountTax(models.Model):
    ...
    is_stamp = fields.Boolean("Timbre Fiscal")
...
class InvoiceStampTax(models.Model):
    ...
    stamp_tax = fields.Many2one('account.tax',string="Timbre Fiscal", domain=[('is_stamp', '=', True)])
    ...
    def _recompute_tax_lines(self, recompute_tax_base_amount=False, tax_rep_lines_to_recompute=None):
        super(InvoiceStampTax, self)._recompute_tax_lines(recompute_tax_base_amount=recompute_tax_base_amount)
        self._recompute_stamp_tax_lines()
