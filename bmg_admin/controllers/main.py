    ...
    def web_login(self, redirect=None, **kw):
        ...
        if request.httprequest.method == 'POST':
            ...
            if 'error' in request.params and request.params.get('error') == 'access':
                values['error'] = _('Seuls les employés peuvent accéder à cette base de données. Veuillez contacter votre administrateur.')
        ...
        if style == 'default' or style is False:
            ...
            response = request.render('bmg_admin.left_login_template', values)
        elif style == 'right':
            response = request.render('bmg_admin.right_login_template', values)
        else:
            response = request.render('bmg_admin.middle_login_template', values)
