...
class ResConfigSettings(models.TransientModel):
    ...
    style = fields.Selection([('default', 'Défaut'), ('left', 'Gauche'), ('right', 'Droite'), ('middle', 'Centré')], help='Select Background Theme')
    background = fields.Selection([('image', 'Image'), ('color', 'Couleur')], default='color', help='Select Background Theme')
    background_image = fields.Many2one('login.image', string="Image", help='Select Background Image For Login Page')
    color = fields.Char(string="Couleur", help="Choose your Background color")
